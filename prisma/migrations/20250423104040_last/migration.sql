/*
  ...
  - Added the required column `pokemonSprite` to the `IntercambioGTS` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_IntercambioGTS" ("estado", "fechaCreacion", "id", "pokemonDeseadoId", "userPokemonId", "usuarioId") SELECT "estado", "fechaCreacion", "id", "pokemonDeseadoId", "userPokemonId", "usuarioId" FROM "IntercambioGTS";
